...
console.log(chalk.bold.magenta("\t\tWelcome To My Cli Typescript Project - 'TABLE GENERATOR'\t\t"));
console.log("\t", "-".repeat(70), "\t");
...
while (myTable) {
    ...
    if (myNumber) {
        ...
        for (let i = 1; i <= 10; i++) {
            console.log(chalk.bold(`${myNumber} x ${i} = ${myNumber * i}`));
        }
    }
    else {
        console.log(chalk.bold.blue("Kindly nnter a value in numerical form!!!"));
    }
